        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }} className="hud-card p-8 col-span-1 md:col-span-2 bg-neon-danger/5 border-neon-danger/20">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-xl font-black tracking-widest text-[var(--color-text-heading)] uppercase">EMERGENCY_OVERRIDE_CONTACT</h2>
            </div>
            <p className="text-sm font-mono text-[var(--color-text-main)] mb-6">In the event of total system failure or critical safety hazard, contact central command immediately.</p>
          ...
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.3 }} className="hud-card p-8">
             <div className="flex items-center gap-4 mb-6 pb-4 border-b border-glass-border">
              ...
              <h2 className="text-lg font-black tracking-widest text-[var(--color-text-heading)] uppercase">Diagnostics Tools</h2>
            </div>
            <div className="space-y-4">
              <button className="w-full text-left px-4 py-3 bg-carbon-800/50 hover:bg-neon-cyan/10 border border-transparent hover:border-neon-cyan/30 rounded-xl transition-all font-mono text-xs text-[var(--color-text-main)] flex justify-between items-center group">
          ...
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }} className="hud-card p-8">
             <div className="flex items-center gap-4 mb-6 pb-4 border-b border-glass-border">
              ...
              <h2 className="text-lg font-black tracking-widest text-[var(--color-text-heading)] uppercase">Manuals & Docs</h2>
            </div>
            <div className="space-y-4">
              <a href="#" className="block px-4 py-3 bg-carbon-800/50 hover:bg-neon-cyan/10 border border-transparent hover:border-neon-cyan/30 rounded-xl transition-all font-mono text-xs text-[var(--color-text-main)]">
