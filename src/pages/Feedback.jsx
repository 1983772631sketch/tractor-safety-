      ...
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }} className="hud-card p-8">
          <div className="flex items-center gap-4 mb-8 pb-6 border-b border-glass-border">
            ...
            <div>
              <h2 className="text-xl font-black tracking-widest text-white uppercase">Field Report Log</h2>
          ...
          {status === 'sent' ? (
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="py-12 text-center">
              ...
              <h3 className="text-2xl font-black text-white tracking-widest uppercase mb-2">Transmission Successful</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <select className="w-full bg-carbon-800/50 border border-glass-border rounded-xl p-4 text-white font-mono focus:outline-none focus:border-neon-cyan/50 focus:bg-neon-cyan/5 transition-all">
              ...
              <div>
                ...
                <textarea 
                  required
                  rows="6"
                  className="w-full bg-carbon-800/50 border border-glass-border rounded-xl p-4 text-white font-mono focus:outline-none focus:border-neon-cyan/50 focus:bg-neon-cyan/5 transition-all resize-none"
